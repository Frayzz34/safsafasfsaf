...
.setColor('Blue')
.setTimestamp()
.addField('`REKLAM VERMEK`',' Para İle Reklam Verebilirsiniz Ne Reklamı Olduğu Farketmez Bot Şuanda \`\`105,361\`\` Kişiye Hizmet Veriyor.Reklam Vermek İçin  <@713678882011742230>  Dm`den Ulaşabilirsiniz. Da Fazla Bilgi İçin Destek Sunucusuna Gelerek <#760989998845132820> Kanalını Okuyabilirsiniz!')
